...
//   or return string.substring(1 , string.length() - 1);
    ...
    public static String[] array() {
        String[] website = new String[1000];
        Arrays.fill(website, "codewars");
        return website;
    }
    ...
    // The integer will be a whole number between 1 and 50.n = 3,
    // so I expect a 3x3 square back just like below as a string:
//    +++
//    +++
//    +++
    public static String generateShape(int a) {
        String[] shape = new String[a];
        for (int i = 0; i < a; i++) {
            shape[i] = "+".repeat(a);
        }
        return String.join("\n", shape);
    ...
    public Long returnNumber(String string) {
        String all = string.toLowerCase().replaceAll("[a-z]", "");
    ...
    //* "String"      -> "SSttrriinngg"
    //* "1234!_ "     -> "11223344!!__  "
    public String repeatedString(String string) {
    ...
    public Boolean possiblePomp(double distanceToPump, double mpg, double fuelLeft) {
    ...
    public static String checkSize(String animal) {
    ...
    public String sayHello(String[] name, String city, String state) {
        ...
        return "Hello, " + join + "! Welcome to " + city + ", " + state + "!";
    }
    ...
    //Input: n = 2, pick = 1
    //Output: 1
/*    public int guessNum(int num, int pick) {
        int low = 1;
        int high = num;
        boolean b = pickNum(pick, num) == 0;
        while (!b) {

        }
    }

    private int pickNum(int pick, int num) {
        if (num > pick) {
            return -1;
        }
        if (num < pick) {
    ...
    //count duplicate od number in array .
    public void showDuplicate() {
        List<Integer> numbers = Arrays.asList(5, 8, 87, 5, 47, 8, 99);
    ...
    //count how many numbers have duplicates in the list
    public int countDuplicate() {
        ...
        for (int countValues : map.values()) {
            if (countValues > 1) {
                duplicatedNumbers++;
            }
        }
    ...
    public static String multiSalary(final Integer salary, final Boolean bonus) {
        int computedSalary = bonus ? salary * 10 : salary;
    ...
    public static String like(String... names) {
        int countLength = names.length;
        return switch (countLength) {
            case 0 -> "no one like this";
            case 1 -> names[0] + " like this";
            case 2 -> names[0] + " and " + names[1] + " like this";
            case 3 -> names[0] + ", " + names[1] + " and " + names[2] + " like this";
            default -> names[0] + ", " + names[1] + " and others like this";
        };
    }
